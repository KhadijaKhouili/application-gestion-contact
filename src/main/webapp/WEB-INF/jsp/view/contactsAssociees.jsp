...
<body>
    <div class="container" style="padding: 20px;">
       <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<h3 class="my-3 text-center">Liste des contacts existants</h3>
            ...
            <thead>
                ...
                <c:forEach items="${contactList}" var="contact">
					<tr>
						...
						<td>
						   <a class="btn btn-success mx-1" href="/AddContactsAuGroupe/${idGroupe}/Contact/${contact.idContact}" role="button">Choisir</a>
