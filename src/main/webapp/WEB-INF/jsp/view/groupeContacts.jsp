...
<body>
    <div class="container" style="padding: 20px;">
       <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<h3 class="my-3 text-center">Liste des contacts du groupe " <c:out value="${nomG}" /> " </h3>
        ...
        <table class="table table-light">
            <thead>
                ...
                <c:forEach items="${groupeListContacts}" var="contact">
					<tr>
						...
						<td>
						   <a class="btn btn-danger mx-1" href="/delete/${contact.idContact}/Groupe/${idGroupe}" role="button">Delete</a>
